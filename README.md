...
Also, as a bonus, rglAnimation is the code for "recording" a series of rotations of the object, the resulting pictures are in /pics, as is the pdf animation.pdf, which plays the animation. The .tex file that produced the animation is also there. 
